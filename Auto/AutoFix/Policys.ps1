# Ricker here, Imma just say that I have modified this script to my liking, but overall it belongs to Evan Greene
...
$LogonLegalNoticeMessage = "Hello, Welcome to the Server"
...
$ExecutionList = @(
    ...
    # "EnableDNSOverDoH",   Ricker here, Keep this disabled, it makes the VM unable to access to the internet, pretty damn important        #18.5.4.1 (2023.01.27 - added support)
